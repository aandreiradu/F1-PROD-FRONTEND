        ...
        <Card className="App">
          <Routes>
            ...
            <Route element={<Persist />}>
              ...
              <Route
                path="/race-results/last"
                element={<LastRaceResults />}
              ></Route>
              <Route
                path="/race-results/:round/results"
                element={<RaceFinished />}
              />
              <Route path="/qualyfing-results" element={<Qualyfing />}></Route>
              <Route path="/schedule/last" element={<Schedule />}></Route>
              <Route
                path="/schedule/:round/:circuitId"
                element={<CircuitSchedule />}
              />
              ...
              />
              <Route
                path="/profile/:username/insert/driver"
                element={<AddDriver />}
              />
              <Route
                path="/profile/:username/insert/team"
                element={<AddTeam />}
              />
            </Route>
          </Routes>
